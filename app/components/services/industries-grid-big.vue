<template>
  <section class="relative w-full px-6 sm:px-10 lg:px-14 py-16 sm:py-20 lg:py-24 bg-white">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        ...
        >
          <div class="group relative h-[400px] sm:h-[450px] lg:h-[500px] rounded-xl overflow-hidden">
            ...
            <div class="absolute inset-6 flex items-start justify-start lg:items-center lg:justify-center">
              <div
                class="bg-white/25 backdrop-blur-xl border border-white/40 rounded-xl p-6 shadow-2xl
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
        ...
        >
          <div class="group relative h-[420px] sm:h-[480px] md:h-[520px] lg:h-[300px] rounded-xl overflow-hidden">
            ...
            <div class="absolute inset-6 flex items-start justify-start lg:items-center lg:justify-center">
              <div
                class="bg-white/20 backdrop-blur-lg border border-white/30 rounded-xl p-6 shadow-2xl
                      opacity-100 lg:opacity-0 lg:group-hover:opacity-100
                      transition-opacity duration-300"
              >
    ...
    <p class="mt-8 text-xs text-dark-grey/50">
