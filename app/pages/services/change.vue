...
import midGreyLogo from '/images/logos/logo_mid_grey.png'
import sprossImage from '/images/services/spross.jpg'
import sixImage from '/images/services/six.png'
import bubblesImage from '/images/bubbles/change.jpg'
